...
base_dir = '/content/drive/Othercomputers/내 노트북 (1)/농산물데이터/apple/data'
...
with open("/content/drive/Othercomputers/내 노트북 (1)/농산물데이터/apple/category.txt", "w") as text_file:
...
while(True):
  ...
  if history1.history['val_accuracy'][0]>0.90:
    model.save(f'/content/drive/Othercomputers/내 노트북 (1)/농산물데이터/models/apple/new/model_{n}.h5')
    n+=1
    ...
    if accuracy>0.90:
      model.save(f'/content/drive/Othercomputers/내 노트북 (1)/농산물데이터/models/apple/new/model_all_90.h5')
      break
